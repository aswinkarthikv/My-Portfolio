        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Aswin Karthik Vijayakumar</span>, a Software Engineer passionate about building scalable applications, AI-powered solutions, and modern digital products. With a strong foundation in software engineering and full-stack development, I transform complex ideas into reliable, secure, and production-ready software.
            </motion.p>
