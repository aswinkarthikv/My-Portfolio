...
const journey: RouteStop[] = [
  {
    ...
    title: 'CYBER SECURITY ADVISORY LAUNCHPAD',
    organization: 'PwC ACCELERATION CENTER',
    description:
      "Completed PwC's Advisory Launchpad Program, gaining exposure to cybersecurity consulting, risk assessment, governance, security awareness, and advisory methodologies while strengthening analytical and problem-solving skills.",
  },
  {
    id: '02',
    ...
    description:
      'Developed responsive web applications and gained hands-on experience in full-stack development using modern web technologies while collaborating on real-world software projects.',
  },
  {
    id: '03',
    year: '2023 – 2027',
    ...
    description:
      'Specializing in Software Engineering, Artificial Intelligence, Full-Stack Development, Cyber Security, and Data Structures while building enterprise-grade projects and maintaining strong academic performance.',
  },
  {
    id: '04',
    year: '2022 – 2023',
    title: 'HIGHER SECONDARY EDUCATION (CBSE)',
    organization: 'ALPHA WISDOM VIDYASHRAM SENIOR SECONDARY SCHOOL',
    description:
      'Completed Physics, Chemistry, Mathematics, and Computer Science with 65.2%, building a strong foundation in analytical thinking, programming fundamentals, and problem-solving.',
  },
  {
    id: '05',
    year: '2020 – 2021',
    ...
    organization: 'ALPHA WISDOM VIDYASHRAM SENIOR SECONDARY SCHOOL',
    description:
      'Completed secondary education with 88.2%, developing core knowledge in Computer Science, Mathematics, and logical reasoning that laid the foundation for engineering studies.',
  },
];
