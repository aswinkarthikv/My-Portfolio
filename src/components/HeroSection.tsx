        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between w-full pt-4 pb-2 my-auto">
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                className="text-[10px] sm:text-[11px] md:text-xs font-normal tracking-[0.22em] uppercase text-[#C4B29E]"
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                SOFTWARE ENGINEER <span className="text-[#8C6D4F] mx-1">•</span> AI ENGINEER <span className="text-[#8C6D4F] mx-1">•</span> FULL STACK DEVELOPER <span className="text-[#8C6D4F] mx-1">•</span> CYBERSECURITY
              </p>
            </motion.div>
            ...
            >
              <p>
                I build scalable software, AI-powered applications, and secure web platforms.
                <br />
                From intelligent automation to full-stack systems,
                <br />
                I transform ideas into production-ready solutions.
              </p>
            </motion.div>
            ...
            >
              ...
              <motion.a
                ...
                download="Aswin_Karthik_Vijayakumar_Resume.pdf"
                target="_blank"
