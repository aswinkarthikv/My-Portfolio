...
const bentoCategories = [
  {
    ...
    items: ['React.js', 'HTML5', 'CSS3', 'JavaScript', 'TypeScript'],
    description:
      'Building responsive, scalable, and maintainable applications with modern frontend technologies, clean architecture, and reusable components.',
    stat: 'FULL STACK',
  ...
  },
  {
    title: 'BACKEND & APIs',
    badge: 'SERVER SIDE',
    items: ['Python', 'Flask', 'FastAPI', 'Node.js', 'REST APIs'],
    description:
      'Developing secure backend services, RESTful APIs, authentication systems, and scalable application logic for production-ready software.',
    stat: 'REST API',
  ...
  },
  {
    ...
    description:
      'Designing efficient database schemas, managing relational and NoSQL databases, and optimizing data access for scalable applications.',
    stat: 'SQL & NoSQL',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    badge: 'INTELLIGENCE',
    items: ['Python', 'Generative AI', 'LLMs', 'Gemini API', 'OpenAI API', 'Docker'],
    description:
      'Building AI-powered applications through LLM integration, prompt engineering, automation workflows, and intelligent software solutions.',
    stat: 'GEN AI',
    colSpan: 'lg:col-span-7',
  },
];
